/*  ----------------------------------------------------------------
    www.prometec.net/oled
    Prog_42_2
    
    Display OLED de 0.96"
    Modificado de http://www.instructables.com/id/How-to-use-OLED-display-arduino-module/
--------------------------------------------------------------------  
*/
     
const int SCL_PIN=12;//D0
const int SDA_PIN=11; //D1
const int RST_PIN=10;//RST
const int DC_PIN =9; //DC
